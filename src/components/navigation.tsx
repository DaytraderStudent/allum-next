        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <nav className="flex items-center justify-between h-20">
            <a href="#" className="relative z-10">
              <span
                className={`text-[22px] font-light tracking-[0.04em] transition-colors duration-500 ${scrolled ? "text-[#0f1a2e]" : "text-white"}`}
              >
                allum
              </span>
            </a>
            ...
            <button
              ...
              className={`lg:hidden p-2 cursor-pointer transition-colors ${scrolled ? "text-[#0f1a2e]" : "text-white"}`}
            >
